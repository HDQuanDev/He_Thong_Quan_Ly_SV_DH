...
?>
<!DOCTYPE html>
<html lang="vn" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="vertical-menu-template">

<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>Đăng Nhập Tài Khoản | Hệ Thống Quản Lý Sinh Viên</title>
        ...
        <div class="authentication-inner row">
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <p class="mb-4">Hệ thống quản lý sinh viên</p>

                    <form>
                        <div class="mb-3">
                            <label for="email" class="form-label">Tên Đăng Nhập</label>
                            <input type="text" class="form-control" id="user" name="email-username" placeholder="" autofocus>
                        </div>
                        ...
                        <button class="btn btn-primary d-grid w-100" type="button" id="button" onclick="login()">
                            Đăng Nhập
                        </button>
                    </form>
                </div>
